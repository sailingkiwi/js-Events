...
function lessContent(){
	var lessLess = document.getElementById("less");
	lessLess.innerHTML="";
	console.log("");
}
...
function zoom(){
	var bigFont = document.getElementById("biggie");
	bigFont.style.fontSize = "150%";
...
var menuItems = ["Ice cream", "French fries", "Mac shake"];
function valueMenu (){
	var menuThree = document.getElementById("menu");
	menuThree.innerHTML = menuItems;
...
var myButton = document.getElementById('displayQuote');
  myButton.innerHTML = myQuote;
  function display(){
